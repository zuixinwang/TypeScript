    ...
    export function createResolutionCache(resolutionHost: ResolutionCacheHost, rootDirForResolution: string | undefined, logChangesWhenResolvingModule: boolean): ResolutionCache {
        ...
        function createHasInvalidatedResolution(forceAllFilesAsInvalidated?: boolean): HasInvalidatedResolution {
            ...
            if (forceAllFilesAsInvalidated) {
                resolutionHost.writeLog(`ResolutionCache:: createHasInvalidatedResolution:: forceAllFilesAsInvalidated: true`);
        ...
        function watchAffectingLocationsOfResolution(resolution: ResolutionWithFailedLookupLocations, addToResolutionsWithOnlyAffectingLocations: boolean, name: string) {
            ...
            if (affectingLocations.length && addToResolutionsWithOnlyAffectingLocations) resolutionsWithOnlyAffectingLocations.push(resolution);
            // Watch package json
        ...
        function createFileWatcherOfAffectingLocation(affectingLocation: string) {
            ...
            if (fileWatcher) {
                ...
                resolutionHost.writeLog(`ResolutionCache:: createFileWatcherOfAffectingLocation:: affectingLocation:${affectingLocation}:: ${fileWatcher.refCount}`);
                return;
            }
            ...
            if (resolutionHost.realpath) {
                ...
                if (path !== locationToWatchPath) {
                    ...
                    if (fileWatcher) {
                        ...
                        resolutionHost.writeLog(`ResolutionCache:: createFileWatcherOfAffectingLocation:: affectingLocation:${affectingLocation}::  ${locationToWatch} ${fileWatcher.refCount}`);
                        return;
                    }
                }
            }
            ...
            resolutionHost.writeLog(`ResolutionCache:: createFileWatcherOfAffectingLocation:: affectingLocation:${affectingLocation}:: ${locationToWatch}  1`);
        ...
        function stopWatchFailedLookupLocationOfResolution<T extends ResolutionWithFailedLookupLocations, R extends ResolutionWithResolvedFileName>(
            ...
            for (const affectingLocation of affectingLocations) {
                ...
                watcher.refCount--;
                resolutionHost.writeLog(`ResolutionCache:: stopWatchFailedLookupLocationOfResolution:: affectingLocation:${affectingLocation}:: ${watcher.refCount}`);
            }
        }
