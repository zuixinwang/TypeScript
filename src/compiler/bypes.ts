namespace ts.Bumbershoot {
    ...
    export interface Symbol extends ts.Symbol {
    ...
    export interface Type extends ts.Type {
        getFlags(): TypeFlags;
    ...
    export interface Signature extends ts.Signature {
    ...
    export interface SourceFileLike extends ts.SourceFileLike {
        getLineAndCharacterOfPosition(pos: number): LineAndCharacter;
        /*@internal*/ sourceMapper?: sourcemaps.SourceMapper;
    }
