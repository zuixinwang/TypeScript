...
console.log(a);`,
        ...
        describe("different options::", () => {
            ...
            function fs(compilerOptions: Omit<CompilerOptions, "module"> & { module?: string; }) {
                return loadProjectFromFiles({
                    "/src/project/tsconfig.json": JSON.stringify({ compilerOptions }),
            ...
            verifyTscWithEdits({
                ...
                fs: () => fs({ composite: true, outFile: "../outFile.js", module: "amd" }),
                commandLineArgs: ["--p", "/src/project"],
                edits: [
                    withOptionChange("with sourceMap", "--sourceMap"),
            ...
            verifyTscWithEdits({
                ...
                fs: () => fs({ incremental: true, outFile: "../outFile.js", module: "amd" }),
                commandLineArgs: ["--p", "/src/project"],
                edits: [
                    withOptionChange("with sourceMap", "--sourceMap"),
                    noChangeWithSubscenario("should re-emit only js so they dont contain sourcemap"),
